...
function Converstion({ data, currentUserId , online}) {
  ...
  return (
    <div  >
      <li className="my-2 p-2 flex flex-row cursor-pointer rounded-lg bg-[#596C7A] hover:bg-gray-200 hover:bg-opacity-50">
        ...
        <div className="w-full flex flex-col justify-center">
          ...
          <div className="flex flex-row justify-between items-center">
            ...
            {/* <span className="text-sm bg-blue-500 rounded-full w-5 h-5 text-center text-white font-bold">4</span> */}
          </div>
        </div>
      </li>
