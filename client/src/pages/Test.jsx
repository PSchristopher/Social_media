...
function Test() {
    ...
    return (
        ...
        //         <div className=''>
        //             <body className=''>
        //                 <div class="flex justify-center h-full chatscreen p-5">
        //                     <section class=" shadow-xl rounded-md w-full lg:w-11/12 lg:mx-auto flex">
        //                         {/*  */}
        //                         <div
        //                             class="w-full md:w-3/6 lg:w-3/6 xl:w-3/6 flex flex-col justify-start items-stretch  bg-white bg-opacity-80 rounded-md lg:rounded-none lg:rounded-l-md p-3">
        ...
        //                                                         <span
        //                                                             class="bg-blue-600 w-4 h-4 text-xs rounded-full text-white font-semibold absolute right-3 top-1">2</span>
        //                                                     </button>
        //                                                 </li>
        ...
        //                                         </div>
        //                                         <div className="">
        //                                             <ul class="min-w-full h-96  overflow-y-scroll overflow-hidden  scrollbar-hide messagelist">
        ...
        //                                                             <span
        //                                                                 class="text-sm bg-blue-500 rounded-full w-5 h-5 text-center text-white font-bold">1</span>
        //                                                         </div>
        //                                                     </div>
        //                                                 </li>
        //                                             </ul>
        ...
        // n  */}
        //                         <div
        //                             class="hidden w-3/6 bg-white h-full md:flex flex-col justify-start items-stretch border-r-2 border-l-2 border-gray-100 lg:rounded-r-md xl:rounded-none">
        //                             {/*
        //   ame  */}
        //                             <div
        ...
        //                             {/*
        //   
        //                             <div class="flex-auto flex flex-col justify-between overflow-y-auto overflow-hidden  scrollbar-hide messagelist">
        ...
        //                                                 class="h-12 w-12 rounded-full self-end" alt="" />
        //                                         </div>
        ...
        //                     <div class="p-5 bg-[#1e354c] flex gap-6 items-center mx-auto   mb-10  rounded-lg sm:flex-row flex-col">
        ...
        //                             <h1 class="text-white text-2xl title-font font-bold mb-2">{UserDetails.fullname}</h1>
        //                             <h2 className='text-gray-300'>{UserDetails.email}</h2>
        //                             <h2 className='text-gray-300'>{UserDetails.mobile}</h2>
        //                             <p class="leading-relaxed text-base">{UserDetails.about}</p>
        ...
        //                                     <p class="title-font font-medium">wmail</p>
        //                                 </div>
        //                             </div>
        //                             <div class=" inline-block mr-2" >
        //                                 <div class="flex  pr-2 h-full items-center">
        ...
        //                             </div>
        //                         </div> */}
        //                             <div class="md:flex font-bold text-blue-300 flex justify-center mt-3">
        ...
        //                                     </div> */}
        //                                 {/* <div class="w-1/2">
        //                                         <h2 class="text-gray-500">FOLLOWING</h2>
        //                                         <p>89</p>
        //                                     </div> */}
        //                                 {/* </div> */}
        //                                 <div class="w-full  md:w-1/2 flex space-x-3">
        //                                     <div class="w-1/2 ">
        //                                         <h2 class="text-gray-200">POSTS</h2>
        //                                         <p className=''>{UserPosts?.length}</p>
        //                                     </div>
        //                                     <div class="w-1/2">
        //                                         <h2 class="text-gray-200">FOLLOWERS</h2>
        //                                         <p>{UserDetails?.followers?.length}</p>
        //                                     </div>
        //                                     <div class="w-1/2">
        //                                         <h2 class="text-gray-200">FOLLOWING</h2>
        ...
        //                                     <button class="block uppercase mx-auto shadow bg-indigo-800 hover:bg-indigo-700 focus:shadow-outline focus:outline-none text-white text-xs py-3 px-10 rounded">follow</button>
        //                                     <button class="block uppercase mx-auto shadow bg-green-800 hover:bg-green-700 focus:shadow-outline focus:outline-none text-white text-xs py-3 px-10 rounded">Message</button>
        //                                 </div>
        //                             </div> */}
